...
public class AppAdapter extends ArrayAdapter<com.example.demo1.DataServices.App> {
    public AppAdapter(@NonNull Context context, int resource, @NonNull List<com.example.demo1.DataServices.App> apps) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        com.example.demo1.DataServices.App app = getItem(position);
